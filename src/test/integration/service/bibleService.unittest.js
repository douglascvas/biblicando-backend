// 'use strict';
//
// var BibleOrgService = require('../../../main/server/serviceClass/bibleService');
...
//     bibleService = new BibleOrgService(config, request, cache);
//
//   });
//
//   it('should get the bibles from the cache', function () {
