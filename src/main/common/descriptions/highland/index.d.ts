...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/1dc239e241cf7f3ceba0c83ded52c11f9d792b32/highland/highland.d.ts
...
declare namespace Highland {
	...
	interface Stream<R> extends NodeJS.EventEmitter {
		...
		sort<U>(f: (x: R) => U): Stream<U>;
		doto<U>(f: (x: R) => U): Stream<U>;
		sortBy<U>(f: (a: R, b: R) => U): Stream<U>;
